...
#File containing peak calls for ENCODE transcription factor ChIP-seq experiements
tfbs='/home/ubuntu/MOLB-7621/data-sets/bed/encode.tfbs.chr22.bed.gz'

#A "genome file" with chromosome size info
